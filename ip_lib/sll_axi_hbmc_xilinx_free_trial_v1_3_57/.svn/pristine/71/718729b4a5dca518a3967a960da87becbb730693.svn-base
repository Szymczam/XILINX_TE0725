...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "g_iavs0_burstcount_width" -parent ${Page_0}
  ipgui::add_param $IPINST -name "g_iavs0_id_width" -parent ${Page_0}
  ipgui::add_param $IPINST -name "g_rds_delay_adj" -parent ${Page_0}
...
proc update_PARAM_VALUE.g_dev0_config { PARAM_VALUE.g_dev0_config PARAM_VALUE.g_is_hyperflash_present } {
	...
	set_property value [gen_USERPARAMETER_g_dev0_config_VALUE $values(g_is_hyperflash_present)] $g_dev0_config
}
...
proc update_PARAM_VALUE.g_dev0_timing { PARAM_VALUE.g_dev0_timing PARAM_VALUE.g_is_hyperflash_present } {
	...
	set g_is_hyperflash_present ${PARAM_VALUE.g_is_hyperflash_present}
	set values(g_is_hyperflash_present) [get_property value $g_is_hyperflash_present]
	set_property value [gen_USERPARAMETER_g_dev0_timing_VALUE $values(g_is_hyperflash_present)] $g_dev0_timing
}
...
proc update_PARAM_VALUE.g_dev1_config { PARAM_VALUE.g_dev1_config PARAM_VALUE.g_is_hyperRAM_present } {
	...
	set_property value [gen_USERPARAMETER_g_dev1_config_VALUE $values(g_is_hyperRAM_present)] $g_dev1_config
}
